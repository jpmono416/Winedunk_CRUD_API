...
public class viewUsers {
    ...
    @Column(name = "preferredCurrencyId")
    ...
    @Column(name = "preferredCurrencyName")
    ...
    @Column(name = "preferredTimeZoneId")
    ...
    @Column(name = "preferredTimeZoneShortName")
    ...
    @Column(name = "preferredTimeZoneName")
    ...
    @Column(name = "preferredTimeZoneUtcOffset")
    ...
    @Column(name = "preferredLanguageShortName")
    ...
    @Column (name = "preferredLanguageName")
    ...
    public viewUsers(String name) { this.name = name;}
}
