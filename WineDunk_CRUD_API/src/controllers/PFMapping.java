...
import services.PFMappingService;
...
public class PFMapping extends HttpServlet {
	...
	@EJB
	PFMappingService mappingService;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		switch(request.getParameter("action"))
		{
			case "getByPFId":
			{
				...
				response.getWriter().write(this.mapper.writeValueAsString(this.mappingService.findByPFId(Integer.valueOf(request.getParameter("id")))));
			}
		}
	}
