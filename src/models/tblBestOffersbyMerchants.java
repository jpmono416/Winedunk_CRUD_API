...
@Entity
@Table(name = "tblBestOffersbyMerchants")
public class tblBestOffersbyMerchants {
	...
	public tblBestOffersbyMerchants(Integer id) { this.id = id; }
	public tblBestOffersbyMerchants()
	{
		this.id = null;
