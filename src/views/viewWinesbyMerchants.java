...
@Entity
@Table(name = "viewWinesbyMerchants")
public class viewWinesbyMerchants extends Object {
	...
	public viewWinesbyMerchants(Integer id) { this.id = id; } 
	public viewWinesbyMerchants() 
	{
        this.id = null;
